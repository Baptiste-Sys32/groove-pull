...
A CLI tool to turn Spotify CSV exports into a perfectly tagged offline MP3 library, complete with official high-res cover art and synchronized scrolling lyrics (`.lrc`).
